...
#else
	cout << "Rename file my_file to my_file_2...." << endl;
	RenameFile();
	cout << "Remove file my_file_2....." << endl;
	RemoveFile();
	cout << "Show all files .exe in directory D...." << endl;
	Dir();
#endif
	cin.get();
	return 0;
...
#else
  strcpy(oldName, "my_file.txt");
  strcpy(newName, "my_file_2.txt");
#endif
